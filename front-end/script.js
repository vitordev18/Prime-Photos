...
function toggleMenuDropdown() {
  if (window.menuManager) {
    window.menuManager.toggleMenuDropdown();
  }
}
...
function closeMenuOnOutsideClick(event) {
  if (window.menuManager) {
    window.menuManager.handleOutsideClick(event);
  }
}

// Fecha menu na tecla Escape
function closeMenuOnEscape(event) {
  if (window.menuManager) {
    window.menuManager.handleEscapeKey(event);
  }
}
...
// Configura fechamento do menu ao clicar
function setupMenuCloseOnClick() {
  if (window.menuManager) {
    window.menuManager.setupMenuCloseOnClick();
  }
}
